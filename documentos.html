  ...
  <nav id="barra-nav" class="" style="margin-bottom:10px;">
    <div class="nav-wrapper be-black z-depth-4">
      ...
      <ul class="right hide-on-med-and-down" id="opciones-nav">
        ...
        <li class="divider-vertical-second-menu"></li>
        <li><a class="animation-nav active-nav" href="documentos.html">Documentos</a></li>
        <li class="divider-vertical-second-menu"></li>
        <li><a class="animation-nav" href="experiencias.html">Experiencias</a></li><li class="divider-vertical-second-menu"></li>
        <li><a class="animation-nav" href="experiencias.html">Redecam</a></li><li class="divider-vertical-second-menu"></li>
      ...
      <ul class="side-nav" id="mobile-demo">
        ...
        <li><a class="mobile-item-nav" href="experiencias.html">Redecam</a></li>
...
<ul class="collapsible col s12" data-collapsible="accordion">
  <li class="">
    <div class="collapsible-header">
      ...
      <p>"Por la cual se fortalece la institucinoalización de la Politica Nacional de Educación Ambiental y su incorporación efectiva en el Desarrollo  Territorial"</p>
