...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-01-2016 a las 17:05:02
...
(2, 'Mision', 'Asesorar, orientar y acompaÃ±ar la institucionalizaciÃ³n de la EducaciÃ³n Ambiental en los sectores gubernamentales, civiles y/o comunitarios a nivel formaL Y no formal.'),
(3, 'Vision', 'Posicionar el comitÃ© tÃ©cnico interinstitucional de educaciÃ³n ambiental del Cauca, como espacio intersectorial y de participaciÃ³n comunitaria que dinamiza la educaciÃ³n ambiental como estrategia para la transformaciÃ³n de la cultura ambiental.'),
...
(1, 'dcdcdcdcdcd', 'dcdcd', '91cd3bd4-34b8-4dd0-9d0b-8487baf8ac0e.jpg', 'dcdcdc');
...
(1, 'inicio', 'https://www.youtube.com/embed/KjramB4Jz14'),
(2, 'nosotros', 'https://www.youtube.com/embed/juzDHz4GfcA');
...
--
ALTER TABLE `documentos`
MODIFY `idDocumento` int(200) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `noticias`
MODIFY `idNoticia` int(99) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
