<?php
 ...
 /**
  * Documentos Data Access Object (DAO).
  * This class contains all database handling that is needed to 
  * permanently store and retrieve Documentos object instances. 
  */
...
class DocumentosDao {
     ...
     */
    function getObject(&$conn, $idDocumento) {

          $valueObject = $this->createValueObject();
          $valueObject->setIdDocumento($idDocumento);
    ...
    function load(&$conn, &$valueObject) {
          ...
          if (!$valueObject->getIdDocumento()) {
               //print "Can not select without Primary-Key!";
               return false;
          }

          $sql = "SELECT * FROM documentos WHERE (idDocumento = ".$valueObject->getIdDocumento().") "; 
    ...
    function loadAll(&$conn) {
          ...
          $sql = "SELECT * FROM documentos ORDER BY idDocumento ASC ";
    ...
    function delete(&$conn, &$valueObject) {
          ...
          $sql = "DELETE FROM documentos WHERE (idDocumento = ".$valueObject->getIdDocumento().") ";
          $result = $this->databaseUpdate($conn, $sql);
    ...
    function searchMatching(&$conn, &$valueObject) {
          ...
          if ($valueObject->getIdDocumento() != 0) {
              if ($first) { $first = false; }
              $sql = $sql."AND idDocumento = ".$valueObject->getIdDocumento()." ";
          }
          ...
          $sql = $sql."ORDER BY idDocumento ASC ";
