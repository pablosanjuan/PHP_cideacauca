<?php
 ...
 /**
  * Contacto Data Access Object (DAO).
  * This class contains all database handling that is needed to 
  * permanently store and retrieve Contacto object instances. 
  */
...
class ContactoDao {
     ...
     */
    function getObject(&$conn, $idContacto) {

          $valueObject = $this->createValueObject();
          $valueObject->setIdContacto($idContacto);
    ...
    function load(&$conn, &$valueObject) {
          ...
          if (!$valueObject->getIdContacto()) {
               //print "Can not select without Primary-Key!";
               return false;
          }

          $sql = "SELECT * FROM contacto WHERE (idContacto = ".$valueObject->getIdContacto().") "; 
    ...
    function create(&$conn, &$valueObject) {
          ...
          $sql = "INSERT INTO contacto ( idContacto, item, descripcion) VALUES (".$valueObject->getIdContacto().", ";
    ...
    function save(&$conn, &$valueObject) {
          ...
          $sql = "UPDATE contacto SET item = '".$valueObject->getItem()."', ";
          $sql = $sql."descripcion = '".$valueObject->getDescripcion()."'";
          $sql = $sql." WHERE (idContacto = ".$valueObject->getIdContacto().") ";
          $result = $this->databaseUpdate($conn, $sql);
    ...
    function delete(&$conn, &$valueObject) {
          ...
          $sql = "DELETE FROM contacto WHERE (idContacto = ".$valueObject->getIdContacto().") ";
          $result = $this->databaseUpdate($conn, $sql);
    ...
    function searchMatching(&$conn, &$valueObject) {
          ...
          if ($valueObject->getIdContacto() != 0) {
              if ($first) { $first = false; }
              $sql = $sql."AND idContacto = ".$valueObject->getIdContacto()." ";
          }
          ...
          $sql = $sql."ORDER BY idContacto ASC ";
    ...
    function singleQuery(&$conn, &$sql, &$valueObject) {
          ...
          if ($row = $conn->nextRow($result)) {
                   ...
                   $valueObject->setIdContacto($row[0]); 
